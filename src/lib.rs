...
mod tests {
    ...
    fn transfer_sol() {
        let keypair = read_keypair_file("dev-wallet.json").expect("Couldn't find wallet file");
        let to_pubkey = Pubkey::from_str("GNu7Z4dFf81YLhdFDGzyyPxagd1PuKXEC1GDHzVCP4ru").unwrap();
    ...
    fn base58_to_wallet() {
        ...
        let wallet = bs58::decode("51SF6wSyfhaai5VaeaP7CE8xaBV5VmbLhj3FBcTsVz6QWox4aJQvR4RSRzxpaKeTTQLiQV1tR9NCyQWwnhSeBseq"
).into_vec().unwrap();
        println!("{:?}", wallet);
    }
    #[test]
